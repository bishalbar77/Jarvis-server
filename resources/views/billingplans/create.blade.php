          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                ...
                <form novalidate action="{{ url('billing-plans/store') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                        ...
                        <li class="d-inline-block mr-2">
                          <fieldset>
                            <div class="vs-checkbox-con vs-checkbox-primary">
                              <input type="checkbox" id="verifications_{{ $verification->id }}" name="billing_verification_tasks[]" value="{{ $verification->name }}">
