      ...
      <div class="card-body">
        <div class="tab-content">
          <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form novalidate action="{{ url('/b2b/update/'.$users->id) }}" method="post">
              {{ csrf_field() }}
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select name="employer_id" class="form-control" required="">
                      ...
                      @foreach($employers as $employer)
                        <option {{ $employerdetails->id == $employer->id ? 'selected' : '' }} value="{{ $employer->id }}">{{ $employer->b2b_company_name }}</option>
                       @endforeach
                    </select>
                  </div>
