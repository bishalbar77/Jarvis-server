      ...
      <div class="card-body">
        <div class="tab-content">
          <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form novalidate action="{{ url('users/store') }}" method="post">
              {{ csrf_field() }}
              <div class="row">
                <div class="col-12 col-sm-5">
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input type="text" name="first_name" class="form-control" placeholder="First Name" value="{{ old('first_name') }}" required data-validation-required-message="This first_name field is required">
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input type="text" name="last_name" class="form-control" placeholder="Last Name" value="{{ old('last_name') }}" required data-validation-required-message="This last_name field is required">
