...
@section('title', 'Create Severity Messeges')
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                ...
                <form novalidate action="{{ url('/severity/messages/store') }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}

                  <div class="form-group">
                    <div class="controls">
                      <label>Severity Message</label>
                      <textarea name="severity_message" class="form-control" placeholder="Severity Message"></textarea>
