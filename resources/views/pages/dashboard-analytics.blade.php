            ...
            <div class="card-content">
              <div class="card-body text-center">
                ...
                <div class="text-center">
                  <h1 class="mb-2 text-white">Congratulations {{ Auth::user()->first_name.' '.Auth::user()->middle_name.' '.Auth::user()->last_name }},</h1>
          ...
          <div class="col-lg-3 col-md-6 col-12">
            <div class="card">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1 mb-25">{{ $employers }}</h2>
          ...
          <div class="col-lg-3 col-md-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <h2 class="text-bold-700 mt-1 mb-25">{{ $employees }}</h2>
                  ...
                  <div class="card-body">
                      <div class="row pb-50">
                          <div class="col-lg-6 col-12 d-flex justify-content-between flex-column order-lg-1 order-2 mt-lg-0 mt-2">
                              <div>
                                  <h2 class="text-bold-700 mb-25">{{ $orders }}</h2>
                                  <p class="text-bold-500 mb-75">Orders</p>
                                  <h5 class="font-medium-2">
                                      <span class="text-success">+5.2% </span>
                                      <span>vs last 7 days</span>
                                  </h5>
                              </div>
                              <a href="{{ url('/orders') }}" class="btn btn-primary shadow">View Details <i class="feather icon-chevrons-right"></i></a>
                          </div>
                  ...
                  <div class="card-body pt-0">
                      <div class="row">
                          <div class="col-sm-2 col-12 d-flex flex-column flex-wrap text-center">
                              <h1 class="font-large-2 text-bold-700 mt-2 mb-0">{{ $created + $inprogress + $complete }}</h1>
                              <small>Tasks</small>
                          </div>
                      ...
                      <div class="chart-info d-flex justify-content-between">
                          <div class="text-center">
                              <p class="mb-50">CREATED</p>
                              <span class="font-large-1">{{ $created }}</span>
                          </div>
                          <div class="text-center">
                              <p class="mb-50">IN PROGRESS</p>
                              <span class="font-large-1">{{ $inprogress }}</span>
                          </div>
                          <div class="text-center">
                              <p class="mb-50">COMPLETED</p>
                              <span class="font-large-1">{{ $complete }}</span>
                          </div>
                      </div>
                  </div>
              </div>
