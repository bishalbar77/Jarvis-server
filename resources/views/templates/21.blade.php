...
.top-description p {
  font-size: 17px !important;
    ...
    <title>Aadhaar Verification Report</title>
</head>
...
<body>
        ...
        <div class="top-part">
            <div class="justify-content-center align-items-center">
                <div class="col-lg-8 col-sm-8 col-8" style="margin-top: -20px; width: 65%; float: left; padding-top: 50px;">
                    <h4>Aadhaar Verification Report</h4>
                    <h6>Client: 
    ...
    <div class="basic-info" style="margin-top: -50px; height: 200px;">
        <div class="row">
            ...
            <div class="top-description" style="margin-left: 180px;">
                ...
                <p>Date of Birth : {{ $employees->dob }}</p>
    ...
    <div class="status-info" style="margin-top: -25px; padding-top: 25px; padding-bottom: 10px; width: 90% !important;">
        <div class="row">
            <div class="col-9">
                <h5 id="h5">Aadhaar Verification Report</h5>                
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12" style="padding-top: 70px; padding-bottom: -40px;">
                ...
                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{  $verificationFields['antecedants_data']['aadhar_number']['name'] ?? '' }}</h4>
                    ...
                    @else
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['aadhar_number']['match_status']) }}">{{ str_replace('_', ' ', $verificationFields['antecedants_data']['aadhar_number']['match_status']) }}</span>
                    <h5 id="p">
                        @php
                ...
                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{  $verificationFields['antecedants_data']['age_band']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; color: 
                    ...
                    @else
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['age_band']['match_status']) }}">{{ str_replace('_', ' ', $verificationFields['antecedants_data']['age_band']['match_status']) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['age_band']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{  $verificationFields['antecedants_data']['gender']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; color: 
                    ...
                    @else
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['gender']['match_status']) }}">{{ str_replace('_', ' ', $verificationFields['antecedants_data']['gender']['match_status']) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['gender']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{  $verificationFields['antecedants_data']['state']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; color: 
                    ...
                    @else
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['state']['match_status']) }}">{{ str_replace('_', ' ', $verificationFields['antecedants_data']['state']['match_status']) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['state']['value'] ?? '' }}</h5>
                </div>
