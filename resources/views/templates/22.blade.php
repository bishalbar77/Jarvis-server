        ...
        <div class="row">
            ...
            <div class="col-12" style="padding-top: 70px; padding-bottom: -40px;">
                ...
                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['candidate_name']['name'] ?? '' }}</h4>
                    @php
                        $addrmatchstatus = $verificationFields['antecedants_data']['candidate_name']['match_status'] ?? '';
                        if($addrmatchstatus == 'NO_MATCHED'){
                            $addrmatchstatus = 'NO_MATCH_FOUND';
                        }
                    @endphp
                    <span id="h5-c" style="float: right; text-transform: uppercase; color: 
                    @if($verificationFields['antecedants_data']['candidate_name']['match_status'] == 'MATCHED')
                        #6cc077;
                    @elseif($verificationFields['antecedants_data']['candidate_name']['match_status'] == 'PARTIAL_MATCHED')
                        #FCD302;
                    @else                        
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['candidate_name']['match_status']) }}">{{ str_replace('_', ' ', $addrmatchstatus) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['candidate_name']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['date_of_birth']['name'] ?? '' }}</h4>
                    @php
                        $addrmatchstatus = $verificationFields['antecedants_data']['date_of_birth']['match_status'] ?? '';
                        if($addrmatchstatus == 'NO_MATCHED'){
                            $addrmatchstatus = 'NO_MATCH_FOUND';
                        }
                    @endphp
                    <span id="h5-c" style="float: right; text-transform: uppercase; color: 
                    @if($verificationFields['antecedants_data']['date_of_birth']['match_status'] == 'MATCHED')
                        #6cc077;
                    @elseif($verificationFields['antecedants_data']['date_of_birth']['match_status'] == 'PARTIAL_MATCHED')
                        #FCD302;
                    @else                        
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['date_of_birth']['match_status']) }}">{{ str_replace('_', ' ', $addrmatchstatus) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['date_of_birth']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['pan_number']['name'] ?? '' }}</h4>
                    @php
                        $addrmatchstatus = $verificationFields['antecedants_data']['pan_number']['match_status'] ?? '';
                        if($addrmatchstatus == 'NO_MATCHED'){
                            $addrmatchstatus = 'NO_MATCH_FOUND';
                        }
                    @endphp
                    <span id="h5-c" style="float: right; text-transform: uppercase; color: 
                    @if($verificationFields['antecedants_data']['pan_number']['match_status'] == 'MATCHED')
                        #6cc077;
                    @elseif($verificationFields['antecedants_data']['pan_number']['match_status'] == 'PARTIAL_MATCHED')
                        #FCD302;
                    @else                        
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['pan_number']['match_status']) }}">{{ str_replace('_', ' ', $addrmatchstatus) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['pan_number']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">PAN Status</h4>
                    @php
                        $pan_status = $verificationFields['antecedants_data']['pan_status'] ?? '';
                    @endphp
                    <span id="h5-c" style="float: right; text-transform: uppercase; color: 
                    ...
                    @else                        
                        #FC1102;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $pan_status) }}">{{ str_replace('_', ' ', $pan_status) }}</span>
