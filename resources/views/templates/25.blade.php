...
<body>
    ...
    <!--Basic Info -->
    <div class="basic-info" style="margin-top: -50px; height: 170px;">
        <div class="row">
    ...
    <div class="status-info" style="margin-top: -25px; padding-top: 25px; padding-bottom: 10px; width: 90% !important;">
        <div class="row">
            <div class="col-9">
                <h5 id="h5">Address Verification Report</h5>                
            </div>
    ...
    <div class="anticents-info" style="margin-top: -15px; margin-bottom: 20px;">
        <div class="row">
            <div class="col-12">
                <h1 id="tab-h1" class="h5-d" style="margin-bottom: 0px;">Verification Details</h1>
            </div>
