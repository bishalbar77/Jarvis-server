...
.top-description p {
  font-size: 17px !important;
    ...
    <title>Digital Address Verification</title>
</head>
...
<body>
    ...
    <div class="status-info" style="margin-top: -35px; padding-top: 20px; padding-bottom: 10px; width: 90% !important;">
        <div class="row">
            <div class="col-9">
                <h5 id="h5">Digital Address Verification</h5>                
            </div>
    ...
    @if($taskhistorydocs)
        ...
        @foreach($taskhistorydocs as $taskhistorydoc)
            ...
            <div class="image-files" style="height: 28.7cm; width: 20cm; margin-left: 20px;">
                <h5 style="margin-top: 20px; margin-bottom: 20px;">{{ $taskhistorydoc->document_name }}</h5>
    ...
    <div class="image-files" style="height: 28.7cm; width: 20cm; margin-left: 20px;">
        <h5 style="margin-top: 20px; margin-bottom: 20px;">Map Address</h5>
        <img src="https://maps.googleapis.com/maps/api/staticmap?size=512x512&maptype=roadmap\
&markers=size:mid%7Ccolor:red%7CSan+Francisco,CA%7COakland,CA%7CSan+Jose,CA&key=AIzaSyDCk2XUru8LFyvD-yVx0Ba8vBbpTpeUg00">
    </div>
