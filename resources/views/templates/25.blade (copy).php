...
p, h1, h2, h3, h4, h5, h6 { font-family: 'Josefin Sans', sans-serif; }
...
<body>
    ...
    <!--Basic Info -->
    <div class="basic-info" style="margin-top: -50px;">
        <div class="row" style="margin-bottom: -130px;">
            ...
            <div class="top-description" style="margin-left: 180px;">
                ...
                <p>Employee Id : {{ $employees->employee_custom_id }}</p>
    ...
    <div class="status-info" style="margin-top: -25px !important; padding-top: 25px; padding-bottom: 0px; width: 90% !important;">
        <div class="row">
            <div class="col-9">
                <h5>Address Verification Report</h5>                
            </div>
    ...
    <div class="anticents-info" style="margin-top: -15px; margin-bottom: 20px;">
        <div class="row">
            ...
            <div class="col-12" style="padding-top: 70px; padding-bottom: -40px;">
                ...
                <div style="width: 97%; padding-left: -10px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['address']['name'] ?? '' }}</h4>
                    <a style="float: right;" href="javascript:void(0)" data-menu="footer-bottom" class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['address']['match_status']) }}">{{ $verificationFields['antecedants_data']['address']['match_status'] }}</a>
                    <h5>{{ $verificationFields['antecedants_data']['address']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -10px !important; margin-bottom: 5px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['accommodation_status']['name'] ?? '' }}</h4>
                    <h5>{{ $verificationFields['antecedants_data']['accommodation_status']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -10px !important; margin-bottom: 5px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['duration_of_stay']['name'] ?? '' }}</h4>
                    <a style="float: right;" href="javascript:void(0)" data-menu="footer-bottom" class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['duration_of_stay']['match_status']) }}">{{ $verificationFields['antecedants_data']['duration_of_stay']['match_status'] }}</a>
                    <h5>{{ $verificationFields['antecedants_data']['duration_of_stay']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -10px !important; margin-bottom: 5px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['above_details']['name'] ?? '' }}</h4>
                    <h5>{{ $verificationFields['antecedants_data']['above_details']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -10px !important; margin-bottom: 5px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['relationship']['name'] ?? '' }}</h4>
                    <h5>{{ $verificationFields['antecedants_data']['relationship']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -10px !important; margin-bottom: 5px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['contact_number']['name'] ?? '' }}</h4>
                    <h5>{{ $verificationFields['antecedants_data']['contact_number']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -10px !important;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['feild_executive']['name'] ?? '' }}</h4>
                    <h5>{{ $verificationFields['antecedants_data']['feild_executive']['value'] ?? '' }}</h5>
                </div>
    ...
    <div class="Terms-Cons" style="position: absolute; bottom: 0; left: 0; width: 100%; height: 30px;">
        <div class="row" style="width: 100%; padding-top: 10px; padding-bottom: 10px;">
            <div class="col-lg-2 col-2" style="width: 21%; float: left;">                    
                <ul style="list-style: none; display: inline-block; padding-top: 7px;">
            ...
            <div class="col-lg-8 col-8" style="text-align: left; !important; width: 72%; float: left;">
                <ul style="padding-top: 3px; margin-left: -30px;">
            ...
            <div class="col-lg-2 col-2" style="float: right; width: 12%;">
                <p style="color: #fff; padding-top: 0px; margin-right: 5px;">Page No. <span class="pagenum"></span></p>
            </div>
        </div>
    </div>
    ...
    <div class="basic-info tc" style="position: absolute; bottom: 50; left: 0;">
        <ol style="padding-top: 5px; padding-right: 10px; margin-bottom: -5px;">
