...
.top-description p {
  font-size: 17px !important;
    ...
    <title>Court Record Check Report</title>
</head>
        ...
        <div class="top-part">
            <div class="justify-content-center align-items-center">
                <div class="col-lg-8 col-sm-8 col-8" style="margin-top: -20px; width: 65%; float: left; padding-top: 50px;">
                    <h4>Court Record Check Report</h4>
    ...
    <div class="anticents-info" style="margin-top: -15px; margin-bottom: 20px;">
        <div class="row">
            ...
            <div class="col-12" style="padding-top: 70px; padding-bottom: -40px;">
                ...
                <div style="width: 97%; padding-left: -15px !important;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['all_civil_courts']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; text-transform: uppercase; text-decoration:none;
                    color: 
                    {{ $verificationFields['antecedants_data']['all_civil_courts']['value'] == 'Match Found' ? '#FC1102' : '#6cc077' }};
                    " href="javascript:void(0)" data-menu="footer-bottom" class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['all_civil_courts']['value']) }}">{{ $verificationFields['antecedants_data']['all_civil_courts']['value'] }}</span>
                    <h5 style="color: #fff;">{{ $verificationFields['antecedants_data']['all_civil_courts']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['session_courts']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; text-transform: uppercase; text-decoration:none;
                    color: 
                    {{ $verificationFields['antecedants_data']['session_courts']['value'] == 'Match Found' ? '#FC1102' : '#6cc077' }};" href="javascript:void(0)" data-menu="footer-bottom" class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['session_courts']['value']) }}">{{ $verificationFields['antecedants_data']['session_courts']['value'] }}</span>
                    <h5 style="color: #fff;">{{ $verificationFields['antecedants_data']['session_courts']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['high_court']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; text-transform: uppercase; text-decoration:none;
                    color: 
                    {{ $verificationFields['antecedants_data']['high_court']['value'] == 'Match Found' ? '#FC1102' : '#6cc077' }};" href="javascript:void(0)" data-menu="footer-bottom" class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['high_court']['value']) }}">{{ $verificationFields['antecedants_data']['high_court']['value'] }}</span>
                    <h5 style="color: #fff;">{{ $verificationFields['antecedants_data']['high_court']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['supreme_court']['name'] ?? '' }}</h4>
                    <span id="h5-c" style="float: right; text-transform: uppercase; text-decoration:none;
                    color: 
                    {{ $verificationFields['antecedants_data']['supreme_court']['value'] == 'Match Found' ? '#FC1102' : '#6cc077' }};" href="javascript:void(0)" data-menu="footer-bottom" class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['supreme_court']['value']) }}">{{ $verificationFields['antecedants_data']['supreme_court']['value'] }}</span>
                    <h5 style="color: #fff;">{{ $verificationFields['antecedants_data']['supreme_court']['value'] ?? '' }}</h5>
                </div>
                ...
                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    ...
                    @php
                        $addrmatchstatus = $verificationFields['antecedants_data']['address']['match_status'] ?? '';
                    ...
                    @if($verificationFields['antecedants_data']['address']['match_status'] == 'MATCHED')
                        #FC1102;
                    @elseif($verificationFields['antecedants_data']['address']['match_status'] == 'PARTIAL_MATCHED')
                        #FC1102;
                    @else                        
                        #6cc077;
                    @endif
                    " class="antecedents-value {{ str_replace(' ', '_', $verificationFields['antecedants_data']['address']['match_status']) }}">{{ str_replace('_', ' ', $addrmatchstatus) }}</span>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['address']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important; margin-bottom: 10px;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['period_of_stay']['name'] ?? '' }}</h4>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['period_of_stay']['value'] ?? '' }}</h5>
                </div>

                <div style="width: 97%; padding-left: -15px !important;">
                    <h4 id="h4" style="margin-bottom: -3px; font-size: 15px;">{{ $verificationFields['antecedants_data']['verifiers_comments']['name'] ?? '' }}</h4>
                    <h5 id="p">{{ $verificationFields['antecedants_data']['verifiers_comments']['value'] ?? '' }}</h5>
                </div>
