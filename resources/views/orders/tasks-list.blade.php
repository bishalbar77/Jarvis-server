          ...
          <form id="frm-filter" action="{{ url('/orders/tasks') }}" method="get">
            <div class="row">
              ...
              <div class="col-12 col-sm-6 col-lg-2">
                <label for="source-filter">Severity</label>
                <fieldset class="form-group">
                  <select name="severity" class="form-control" id="severity-filter" onchange="filterFrm()">
                    <option value="">Severity</option>
                    <option <?php echo (isset($severity) && $severity === 'GREEN') ? 'selected' : ''; ?> value="GREEN">GREEN</option>
                    <option <?php echo (isset($severity) && $severity === 'YELLOW') ? 'selected' : ''; ?> value="YELLOW">YELLOW</option>
                    <option <?php echo (isset($severity) && $severity === 'RED') ? 'selected' : ''; ?> value="RED">RED</option>
                  </select>
                </fieldset>
              </div>
              <div class="col-6 col-sm-4 col-lg-2">
                                ...
                                @if($orders)                                  
                                  <tbody>
                                    @foreach($orders as $order)
                                      <tr>
                                        <td>
                                          <a href="{{ url('/orders/task/'.$order->orderId.'/'.$order->id) }}">
                                            {{ $order->task_number }}
                                          </a>
                                        </td>
                                        <td>
