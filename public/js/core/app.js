    ...
    // alert('I am here');
      ...
      if (value != "") {
        ...
        var $startList = "",
            ...
            // var csrf_token_id = $('#csrf_token_id').val();
            // $.ajaxSetup({
            //     headers: {
            //         'X-CSRF-TOKEN': csrf_token_id
            //     }
            // });

            // $.ajax({
            //     type :'POST',
            //     url  :'/searches/all-modules',
            //     data: {
            //         s : $(this).val(),
            //     },
          ...
          $.ajax({
              ...
              success:function(data){
                // $htmlList = $pageList.concat(data);
                $("ul.search-list").html(data);
                console.log(data);
              }
          });
          ...
          $("ul.search-list").append($htmlList); // concatinating otherlist with startlist
...
module.exports = __webpack_require__(/*! /var/www/html/truehelp/resources/js/core/app.js */"./resources/js/core/app.js");
